...
public class TestOneToMany {
	...
	public static void main(String[] args) {
		Employee e1=new Employee(1,"Ram",100000);
		Employee e2=new Employee(2,"Sham",200000);
		Employee e3=new Employee(3,"Shita",300000);
		Employee e4=new Employee(4,"Maruti",400000);
